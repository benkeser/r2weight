...
#' @param SL.library.Q A \code{vector} or \code{list} of the Super Learner library to be used for the
#' outcome regression. See \code{?SuperLearner} for more details. For now the same \code{SL.library} is used
#' for prediction of each outcome. 
#' @param SL.library.g A \code{vector} or \code{list} of the Super Learner library to be used for the
#' propensity score. See \code{?SuperLearner} for more details. For now the same \code{SL.library} is used
#' for prediction of each outcome. 
...
#' @param SuperLearner.V The number of CV folds for the \code{SuperLearner}.
...
#' By default will use \code{parallel::detectCores()}. Not developed yet.
...
optWeightEff <- function(Y, X, Z, SL.library.Q, SL.library.g,
    ...
    out$SL.library.Q <- SL.library.Q
    out$SL.library.g <- SL.library.g
    out$CV.SL.fits <- NULL
